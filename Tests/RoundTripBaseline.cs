...
namespace SECmd.Tests
{
    ...
    public static class RoundTripBaseline
    {
        ...
        public static readonly Dictionary<string, string> ByDesign = new(StringComparer.Ordinal)
        {
            ...
            // `Bone Weights` used to be excused here -- "a vertex holds four influences;
            // more are reduced and renormalised" -- and it is gone, because it was true
            // of very few of the differences it was excusing and the field needs no
            // excuse at all now. The reduction it describes is real, and `NifComparer`
            // works it out for this copy of the weights the way it always did for the
            // partition's, rather than the whole field being waved through: one FaceGen
            // head reported 1,084 differences here and its busiest vertex has three
            // influences.
